...
class reflex extends mod_model {
    ...
    **/
    ...
    public static function get($class,$id=null,$data=null) {
        ...
        $class = reflex_util::getItemClass($class);

        // Вызов функции с одним аргументом возвращает коллекцию
        if(func_num_args()==1)
            return reflex_collection::get($class);
    ...
    public static function storeAll() {
        ...
        mod_profiler::addMilestone("reflex before store");
        ...
        mod_profiler::addMilestone("reflex stored");
    }
