 ...
 **/
class reflex_collection extends mod_component implements Iterator {
    ...
    public static function get($class) {
        $list = reflex_util::getListClass($class);
    ...
    public function table() {
        return reflex_table::factoryTableForReflexClass($this->itemClass());
    }
    ...
    public function normalizeColName($key) {
        return reflex::normalizeColName($key,$this->itemClass());
    }
    ...
    public function first() {
        ...
        $ret = $this->items[0];
        if(!$ret)
            return reflex::get($items->itemClass(),0);
        return $ret;
    }
