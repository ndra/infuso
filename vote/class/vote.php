...
class vote extends reflex {
    ...
    public function options() {
        return vote_option::all()->eq("voteID",$this->id())->eq("draft", 0);
    }
    
    /**
     * @return Возвращает коллекцию вариантов пользовательских ответов на вопрос
     **/
    public function draftOptions() {
        return vote_option::all()->eq("voteID",$this->id())->eq("draft", 1);
    }
    
    /**
     * @return Возвращает коллекцию всех вариантов пользовательских ответов на вопрос
     **/
    ...
    public function reflex_children() { return array(
        ...
        $this->draftOptions()->title("Варианты ответа от пользователей")->param("sort",true),
